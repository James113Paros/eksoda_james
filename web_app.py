...
CAT_COLORS = {
    ...
    "Σούπερ Μάρκετ": "#6BCB77", "Συνδρομές": "#4D96FF", "Ψώνια": "#C77DFF", "Διάφορα": "#F4A261", "Καφές": "#C9A96E", "Βενζίνη": "#E63946",
}
...
<div id="tab-add" class="panel active">
  ...
  <div class="card">
    ...
    <div class="cat-grid">
      ...
      <button class="cat-btn" data-cat="Βενζίνη" onclick="selectCat(this)"><span class="emoji">⛽</span>Βενζίνη</button>
    </div>
  </div>
